...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`border-r border-border hidden md:block ${expanded ? "w-80" : "w-20"}`}
    >
      <header className="border-b border-border h-15 flex justify-between items-center px-4">
        {expanded && (
        ...
        <div className={`w-full ${expanded ? 'flex justify-end' : 'flex justify-center'}`}>
          <button
            onClick={() => setExpanded((curr) => !curr)}
            className="size-10 p-2 bg-bg rounded-md center border border-border cursor-pointer"
          >
